...
public final class FragmentInsightsBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvMerchant1Amount;

  @NonNull
  public final TextView tvMerchant1Details;

  @NonNull
  public final TextView tvMerchant1Name;

  @NonNull
  public final TextView tvMerchant2Amount;

  @NonNull
  public final TextView tvMerchant2Details;

  @NonNull
  public final TextView tvMerchant2Name;

  @NonNull
  public final TextView tvMerchant3Amount;

  @NonNull
  public final TextView tvMerchant3Details;

  @NonNull
  public final TextView tvMerchant3Name;
  ...
  private FragmentInsightsBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull SwipeRefreshLayout swipeRefreshLayout, @NonNull TextView tvMerchant1Amount,
      @NonNull TextView tvMerchant1Details, @NonNull TextView tvMerchant1Name,
      @NonNull TextView tvMerchant2Amount, @NonNull TextView tvMerchant2Details,
      @NonNull TextView tvMerchant2Name, @NonNull TextView tvMerchant3Amount,
      @NonNull TextView tvMerchant3Details, @NonNull TextView tvMerchant3Name,
      @NonNull TextView tvMonthlySavings, @NonNull TextView tvPatternAlert1,
      @NonNull TextView tvPatternAlert2, @NonNull TextView tvSavingsRecommendation1,
      @NonNull TextView tvSavingsRecommendation2, @NonNull TextView tvSpendingAdvice,
      @NonNull TextView tvSpendingAmount, @NonNull TextView tvSpendingProgress,
      @NonNull TextView tvYearlySavings) {
    ...
    this.tvMerchant1Amount = tvMerchant1Amount;
    this.tvMerchant1Details = tvMerchant1Details;
    this.tvMerchant1Name = tvMerchant1Name;
    this.tvMerchant2Amount = tvMerchant2Amount;
    this.tvMerchant2Details = tvMerchant2Details;
    this.tvMerchant2Name = tvMerchant2Name;
    this.tvMerchant3Amount = tvMerchant3Amount;
    this.tvMerchant3Details = tvMerchant3Details;
    this.tvMerchant3Name = tvMerchant3Name;
  ...
  public static FragmentInsightsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvMerchant1Amount;
      TextView tvMerchant1Amount = ViewBindings.findChildViewById(rootView, id);
      if (tvMerchant1Amount == null) {
        break missingId;
      }

      id = R.id.tvMerchant1Details;
      TextView tvMerchant1Details = ViewBindings.findChildViewById(rootView, id);
      if (tvMerchant1Details == null) {
        break missingId;
      }

      id = R.id.tvMerchant1Name;
      TextView tvMerchant1Name = ViewBindings.findChildViewById(rootView, id);
      if (tvMerchant1Name == null) {
        break missingId;
      }

      id = R.id.tvMerchant2Amount;
      TextView tvMerchant2Amount = ViewBindings.findChildViewById(rootView, id);
      if (tvMerchant2Amount == null) {
        break missingId;
      }

      id = R.id.tvMerchant2Details;
      TextView tvMerchant2Details = ViewBindings.findChildViewById(rootView, id);
      if (tvMerchant2Details == null) {
        break missingId;
      }

      id = R.id.tvMerchant2Name;
      TextView tvMerchant2Name = ViewBindings.findChildViewById(rootView, id);
      if (tvMerchant2Name == null) {
        break missingId;
      }

      id = R.id.tvMerchant3Amount;
      TextView tvMerchant3Amount = ViewBindings.findChildViewById(rootView, id);
      if (tvMerchant3Amount == null) {
        break missingId;
      }

      id = R.id.tvMerchant3Details;
      TextView tvMerchant3Details = ViewBindings.findChildViewById(rootView, id);
      if (tvMerchant3Details == null) {
        break missingId;
      }

      id = R.id.tvMerchant3Name;
      TextView tvMerchant3Name = ViewBindings.findChildViewById(rootView, id);
      if (tvMerchant3Name == null) {
        break missingId;
      }
      ...
      return new FragmentInsightsBinding((ConstraintLayout) rootView, btnCreateSavingsPlan,
          ...
          tvMerchant1Amount, tvMerchant1Details, tvMerchant1Name, tvMerchant2Amount,
          tvMerchant2Details, tvMerchant2Name, tvMerchant3Amount, tvMerchant3Details,
          tvMerchant3Name, tvMonthlySavings, tvPatternAlert1, tvPatternAlert2,
          tvSavingsRecommendation1, tvSavingsRecommendation2, tvSpendingAdvice, tvSpendingAmount,
          tvSpendingProgress, tvYearlySavings);
    }
