...
class ExportDataFragment : Fragment() {
    ...
    private suspend fun generateMonthlySummaries(transactions: List<com.expensemanager.app.data.entities.TransactionEntity>): List<MonthlySummary> {
        val monthlyData = mutableMapOf<String, MutableList<com.expensemanager.app.data.entities.TransactionEntity>>()
