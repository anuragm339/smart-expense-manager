...
import com.smartexpenseai.app.data.models.AICallThresholds
import com.smartexpenseai.app.data.models.AICallTracker
import com.smartexpenseai.app.data.models.CallFrequency
import com.smartexpenseai.app.data.models.ThresholdEvaluationResult
import com.smartexpenseai.app.data.models.ThresholdProgress
import com.smartexpenseai.app.data.models.Transaction
import com.smartexpenseai.app.data.models.TriggerReason
...
class AIThresholdService @Inject constructor(
    ...
    private val userDao: com.smartexpenseai.app.data.dao.UserDao,
    ...
    suspend fun updateAfterSuccessfulCall(
        ...
        val tier = user?.let { com.smartexpenseai.app.data.entities.SubscriptionTier.fromString(it.subscriptionTier) }
    ...
    private suspend fun isRateLimited(tracker: AICallTracker, now: Long): Boolean {
        ...
        val tier = com.smartexpenseai.app.data.entities.SubscriptionTier.fromString(user.subscriptionTier)
