...
import com.smartexpenseai.app.data.repository.AIInsightsRepository
import com.smartexpenseai.app.data.repository.ExpenseRepository
import com.smartexpenseai.app.databinding.FragmentInsightsBinding
import com.smartexpenseai.app.domain.insights.InsightsUseCaseFactory
import com.smartexpenseai.app.services.DateRangeService
import com.smartexpenseai.app.services.DateRangeService.Companion.DateRangeType
import com.smartexpenseai.app.services.TimeSeriesAggregationService
import com.smartexpenseai.app.services.TimeSeriesAggregationService.TimeSeriesData
import com.smartexpenseai.app.services.DateRangeService.Companion.TimeAggregation
import com.smartexpenseai.app.services.ChartConfigurationService
...
class InsightsFragment : Fragment() {
    ...
    private fun setupViewModel() {
        try {
            ...
            val database = com.smartexpenseai.app.data.database.ExpenseDatabase.getDatabase(requireContext())
    ...
    private suspend fun applyFiltersToTransactions(
        transactions: List<com.smartexpenseai.app.data.entities.TransactionEntity>,
        filters: ChartFilterConditions
    ): List<com.smartexpenseai.app.data.entities.TransactionEntity> {
     ...
     */
    private suspend fun getCategoryNameForTransaction(transaction: com.smartexpenseai.app.data.entities.TransactionEntity): String {
        return try {
            val expenseRepository = ExpenseRepository.getInstance(requireContext())
     ...
     */
    private fun setupCategoryPieChart(categorySpendingResults: List<com.smartexpenseai.app.data.dao.CategorySpendingResult>) {
     ...
     */
    private fun setupPieChartData(pieChart: PieChart, categorySpendingResults: List<com.smartexpenseai.app.data.dao.CategorySpendingResult>) {
        try {
     ...
     */
    private fun getCategoryColors(categorySpendingResults: List<com.smartexpenseai.app.data.dao.CategorySpendingResult>): List<Int> {
     ...
     */
    private fun setupCategoryLegend(chartView: View, categorySpendingResults: List<com.smartexpenseai.app.data.dao.CategorySpendingResult>, totalAmount: Double) {
        try {
     ...
     */
    private suspend fun getFilteredCategorySpending(expenseRepository: ExpenseRepository): List<com.smartexpenseai.app.data.dao.CategorySpendingResult> {
        try {
     ...
     */
    private fun updateCategoryChartSummaryStats(chartView: View, categoryData: List<com.smartexpenseai.app.data.dao.CategorySpendingResult> = emptyList()) {
    ...
    private fun updateChartSummaryStats(categoryData: List<com.smartexpenseai.app.data.dao.CategorySpendingResult> = emptyList()) {
