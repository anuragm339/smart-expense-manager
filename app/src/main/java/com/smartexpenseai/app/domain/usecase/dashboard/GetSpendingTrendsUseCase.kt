package com.smartexpenseai.app.domain.usecase.dashboard
...
class GetSpendingTrendsUseCase @Inject constructor(
     ...
     */
    private fun calculateDailySpending(transactions: List<com.smartexpenseai.app.data.entities.TransactionEntity>): List<DailySpending> {
        val calendar = Calendar.getInstance()
        val dailyMap = mutableMapOf<String, MutableList<com.smartexpenseai.app.data.entities.TransactionEntity>>()
     ...
     */
    private fun calculateWeeklySpending(transactions: List<com.smartexpenseai.app.data.entities.TransactionEntity>): List<WeeklySpending> {
        val calendar = Calendar.getInstance()
        val weeklyMap = mutableMapOf<String, MutableList<com.smartexpenseai.app.data.entities.TransactionEntity>>()
     ...
     */
    private fun calculateCategoryTrends(transactions: List<com.smartexpenseai.app.data.entities.TransactionEntity>): List<CategoryTrend> {
