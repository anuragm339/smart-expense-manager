...
import com.smartexpenseai.app.data.repository.internal.AIInsightsCacheManager
...
class AIInsightsRepository @Inject constructor(
    ...
    private val insightsHistoryManager: com.smartexpenseai.app.services.InsightsHistoryManager,
    private val csvGenerator: com.smartexpenseai.app.services.TransactionCSVGenerator,
    private val aiThresholdService: com.smartexpenseai.app.services.AIThresholdService
) {
        ...
        fun getInstance(context: Context, expenseRepository: ExpenseRepository, aiCallDao: AICallDao,
            ...
            return INSTANCE ?: synchronized(this) {
                ...
                val instance = AIInsightsRepository(
                    ...
                    com.smartexpenseai.app.services.InsightsHistoryManager(context.applicationContext, gson),
                    com.smartexpenseai.app.services.TransactionCSVGenerator(expenseRepository),
                            com.smartexpenseai.app.services.AIThresholdService (
                        context.applicationContext,
                        expenseRepository,
                        aiCallDao,
                        userDao,
    ...
    private suspend fun fetchInsightsFromApi(): Result<List<AIInsight>> = withContext(Dispatchers.IO) {
        return@withContext try {
            ...
            val csvMetadata = com.smartexpenseai.app.data.api.insights.CSVMetadata(
     ...
     */
    private suspend fun gatherPreviousPeriodData(): com.smartexpenseai.app.data.api.insights.PreviousPeriodData? {
        return try {
            ...
            val categorySpending = previousData.topCategories.map {
                com.smartexpenseai.app.data.api.insights.CategorySpending(
            ...
            val merchantSpending = previousData.topMerchants.map {
                com.smartexpenseai.app.data.api.insights.MerchantSpending(
            ...
            com.smartexpenseai.app.data.api.insights.PreviousPeriodData(
